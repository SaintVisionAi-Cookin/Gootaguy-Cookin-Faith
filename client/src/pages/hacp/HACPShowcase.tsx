...
export default function HACPShowcase() {
  return (
    <div className="min-h-screen flex flex-col bg-black">
      <Header title="HACP Framework Showcase" />
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="max-w-xl w-full text-center">
          ...
          <div className="mt-8">
            <h4 className="text-lg font-bold text-white mb-2">Dedication</h4>
            <p className="text-gray-400 text-sm">
              This page is dedicated to the visionaries and engineers who made the HACP framework a reality. Thank you for your relentless pursuit of human-AI synergy.
            </p>
          </div>
        </div>
      </main>
